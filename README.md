...
This makes it possible to train on a **free Google Colab T4 GPU** (15GB VRAM) effeciently.
...
├── scraper.py                # Beautifulsoup + Cloudscraper script for GFG
├── requirements.txt          # Python dependencies
├── README.md                 # Documentation (this file)
├── dataset_batches/          # Folder containing 50-pair dynamically weighted JSON batches
...
| `scraper.py` | GScrapes naturally commented code from GFG and parses it |
| `dataset_batches/` | The final batched JSON dataset used for training |
